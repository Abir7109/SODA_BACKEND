...
def _build_system_prompt():
    ...
    base = (
        ...
        "LANGUAGE RULE — Always reply in whichever language Abir sir is using with you: "
        "if he speaks or writes Bengali (Bangla), reply in Bengali; if English, reply in English. "
        "Never mix languages mid-reply, and never reply in Hindi or any other Indian language. "
