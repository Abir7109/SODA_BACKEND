...
def _build_system_prompt():
    ...
    base = (
        ...
        "APP OPENING — When Abir sir says 'open [app]', 'launch [app]', 'start [app]': "
         ...
         "open_app returns a 'detail' field with what actually happened (e.g. 'Process chrome.exe started'). "
         "READ the detail field and tell the user what happened. Do NOT say 'opened' if the result "
         "shows success=False. If success=False, say 'I couldn't find [app] on your system' and "
         "suggest installing it or trying a different name. "
...
"  • whatsapp_find_and_message(contact_name, message) — sends a WhatsApp message\n"
...
"- When user says 'send WhatsApp to [name] saying [message]', 'tell [name] [message] on WhatsApp', "
"'WhatsApp [name] that [message]', 'message [name]', 'text [name]' — IMMEDIATELY call "
"whatsapp_find_and_message(contact_name='<exact name>', message='<full message>').\n"
"- When user says 'call [name] on WhatsApp', 'WhatsApp call [name]' — call "
